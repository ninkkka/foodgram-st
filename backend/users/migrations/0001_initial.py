    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(max_length=150, validators=[django.core.validators.RegexValidator(message='Введите корректное имя.', regex='^[A-Za-zА-Яа-яЁё -]+$'), users.models.validate_not_me], verbose_name='Имя')),
                ('last_name', models.CharField(max_length=150, validators=[django.core.validators.RegexValidator(message='Введите корректную фамилию.', regex='^[A-Za-zА-Яа-яЁё -]+$'), users.models.validate_not_me], verbose_name='Фамилия')),
